...
const collide = {
    up: (r1, r2) => r1.getBottom() > r2.getTop() && r1.getTop() < r2.getTop(),
    down: (r1, r2) => r1.getTop() < r2.getBottom() && r1.getBottom() > r2.getBottom(),
...
function collideBlock(player, rectangle) {
    ...
    if (collide.up(player, rectangle)) {

        player.setBottom(rectangle.getTop())
        player.grounded = true

    }
    if (collide.down(player, rectangle)) {
...
export { isColliding, collideBlock }